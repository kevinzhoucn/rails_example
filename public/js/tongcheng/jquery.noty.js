...
(function ($) {
    ...
    $.noty.defaults = {
        ...
        text:'',
        dismissQueue:true,
        template: '<div class="noty_message"><table><tr><td style="height:60px;" valign="middle"><span class="noty_text"></span></td></tr></table><div class="noty_close"></div></div>',//<img src="/images/Button/tips_ico1.png" style="vertical-align:middle;margin-right: 10px;"/>
        animation:{
            open:{height:'toggle'},
            close:{height:'toggle'},
            easing:'swing',
